INSERT INTO games (image_url, big_image_url, name, link, description)
VALUES ('/static/images/Hgwarts.png', '/static/images/BigArtHogwarts.png', 'Гоґвортс НРГ', 'https://drive.google.com/file/d/1oHWk77AKFZpPCCApyMnKZ-reYLVWEOHL/view', 'Ласкаво просимо до Гоґвортсу! Ви збираєтеся сплести історію про таємниці, дружбу, небезпеку та магію. Цей посібник навчить вас грати в гру, ознайомивши вас з усім для першої сесії. Посібник достатньо прочитати тільки одному гравцю та Оповідачу. Усі інші можуть вчитися на їх грі. Давайте почнемо!');

INSERT INTO games (image_url, big_image_url, name, description, link)
VALUES ('/static/images/Arkandia.png', '/static/images/BigArtArkandia.png',
